...
public class PredictorClassGenerator extends ClassLoader implements Generator, Opcodes {
    ...
    private static final String PREDICTOR_INTERNAL_NAME = "io/github/treetops/core/predictor/Predictor";

    private static final String META_DATA_HOLDER_INTERNAL_NAME = "io/github/treetops/core/predictor/MetaDataHolder";
